...
export function buildContentPrompt({ topic, dateIso }) {
  ...
  return [
    ...
    '  "tags": string[],    // 20–25 hashtagów wg strategii zasięgu opisanej poniżej',
    ...
    slideSchema,
    "",
    "Strategia hashtagów (dla pola \"tags\") — dobierz 20–25 tagów według TRZECH warstw:",
    "WARSTWA 1 — 4–5 dużych tagów (1M–10M postów): szerokie dotarcie, np. #instagrammarketing #socialmediastrategy #contentcreator",
    "WARSTWA 2 — 10–12 średnich tagów (100k–1M postów): złoty środek zasięg/konkurencja, np. #instagramtips #marketingtips #growyourbusiness",
    "WARSTWA 3 — 5–7 niszowych tagów (10k–100k postów): łatwiej wyjść na TOP, zaangażowana społeczność, np. #instagrampolska #marketingpolska",
    "ZASADY: (1) Unikaj tagów >50M postów (#love, #instagood, #photo) — treść ginie w sekundach.",
    "(2) Mix języków: 60% angielskie (globalny zasięg) + 40% polskie (lokalna społeczność).",
    "(3) Tagi muszą być tematycznie powiązane z treścią — zero spamu.",
    "",
...
export function buildCombinedPrompt({ topic, dateIso }) {
  ...
  return [
    ...
    "Zwróć WYŁĄCZNIE poprawny JSON (bez markdown, bez komentarzy) w formacie:",
    "{",
    '  "tags": string[],     // 20–25 hashtagów wspólnych dla obu formatów, wg strategii zasięgu poniżej',
    '  "carousel": {',
